...
import type { LandingFaq as LandingFaqItem } from '@/components/marketing/landing/content';
import { fetchSaasPlans } from '@/lib/marketing/server-api';
...
import { buildFaqs, SECTION_IDS } from '@/components/marketing/landing/content';
import { LIGHT_SAAS, paletteVars } from '@/components/marketing/landing/palette';
      ...
      ...(plans.length > 0
        ? {
            offers: plans.map((plan) => ({
              ...
              url: `${SITE_ORIGIN}/cadastro?plano=${encodeURIComponent(plan.id)}`,
            })),
          }
        : {}),
    },
