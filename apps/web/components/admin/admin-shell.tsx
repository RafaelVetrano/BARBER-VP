...
const NAV: Array<{ key: string; label: string; href: string; icon: ReactNode }> = [
  { key: 'tenants', label: 'Tenants', href: '/admin/tenants', icon: <UsersIcon size={19} /> },
  { key: 'planos', label: 'Planos', href: '/admin/planos', icon: <ReceiptIcon size={19} /> },
  { key: 'billing', label: 'Billing', href: '/admin/billing', icon: <MoneyIcon size={19} /> },
  { key: 'metricas', label: 'Métricas', href: '/admin/metricas', icon: <BarChartIcon size={19} /> },
  // Fase 09 — operação da plataforma.
  { key: 'filas', label: 'Filas', href: '/admin/filas', icon: <GridIcon size={19} /> },
  { key: 'mensagens', label: 'Mensagens', href: '/admin/mensagens', icon: <ChatIcon size={19} /> },
];
